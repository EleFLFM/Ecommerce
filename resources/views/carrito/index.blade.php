...
<style>
    .dark-container {
        background-color: #1a202c; /* Un gris oscuro agradable */
    ...
    .dark-table {
        ...
        margin-top: 20px;
        background-color: #2d3748; /* Un tono más claro para la tabla */
        color: #cbd5e0;
    }
    ...
    .dark-table tbody tr:hover {
        background-color: #3b485c; /* Un ligero cambio al pasar el mouse */
    }
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('carrito.actualizar') }}" method="POST" class="d-inline">
                                    ...
                                    <input type="number" name="cantidad" value="{{ $item['cantidad'] }}" min="1" class="dark-input-number">
                                    <button type="submit" class="dark-btn-secondary">Actualizar</button>
                                </form>
                            </td>
